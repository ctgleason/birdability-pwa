...
// Setup conditional sections (show/hide based on Yes/No answers)
function setupConditionalSections() {
    // Define all conditional sections
    ...
    const data = {
        ...
        accessibilityDetailed: {
            ...
            bathrooms: {
                ...
                toiletSeatHeight17to19: false,
                sinkHeightMax34: false,
                mirrorBottomMax40: false,
                handDryersMax35: false,
